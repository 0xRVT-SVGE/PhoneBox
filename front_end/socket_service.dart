...
class SocketService {
  ...
  /// Restart alarm sound after admin quits resolution without finishing.
  ...
  /// Clear only DVW callbacks. Safe to call from ScanSuccessPage.dispose()
  /// without losing alarm or admin callbacks registered by other pages.
  ...
  /// Clear only admin resolution callbacks.
